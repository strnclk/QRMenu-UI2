          ...
          <q-btn round flat>
            ...
            <q-menu class="shadow-card">
              <q-card flat style="width: 25em;" class="shadow-card my-text-color">
                <q-card-section>
                  <div class="text-bold text-h6 q-px-md">Kullanıcı Profili</div>
                  ...
                  <div class="row q-mt-md">
                    <q-list>
                      <q-item>
                        ...
                        <q-item-section>
                          <q-item-label class="text-bold">Profilim</q-item-label>
                          <q-item-label caption lines="1">Ayarlar</q-item-label>
                        </q-item-section>
                      </q-item>
                      <q-item>
                        <q-item-section avatar>
                        ...
                        <q-item-section>
                          <q-item-label class="text-bold">Parolayı Değiştir</q-item-label>
                        </q-item-section>
                      </q-item>
                    </q-list>
                  </div>
      ...
      <div class="q-ml-md q-mb-lg q-mt-lg">
        <div class="row">
          <div class="row q-col-gutter-x-md items-center">
            ...
            <div class="col-auto">
              <div class="text-h5 text-bold text-primary">KÖŞEBAŞI</div>
            </div>
          </div>
        </div>
      </div>
